...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Inventory_t, stringdata0) + ofs), len 
...
const QMetaObject Inventory::staticMetaObject = { {
    ...
    qt_meta_stringdata_Inventory.offsetsAndSize,
    qt_meta_data_Inventory,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Inventory_t
